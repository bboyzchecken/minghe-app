 ...
 *
 * คำในไฟล์นี้คือคำที่ผู้ใช้จะเห็นจริง — ที่อื่นในระบบต้องใช้คำเดียวกันนี้เสมอ
 * มีเทสต์ `tests/glossary.test.ts` กันคำเก่าหลุดกลับเข้ามาใน `packages/core/src`
 */
...
const CORE_TERMS: Record<CoreGlossaryKey, GlossaryTerm> = {
  USEFUL_GOD: {
    ...
    cn: '用神',
    pinyin: 'yòngshén',
    // คำที่ อ.เม ยืนยันเอง (คำตอบ 8 ก.ย. 2026 ข้อ 2.1) — ห้ามเปลี่ยนโดยไม่ถามท่านก่อน
    th: 'ธาตุอุปถัมภ์',
    workMeaning:
  ...
  LUCK_PILLAR: {
    ...
    cn: '大運',
    pinyin: 'dàyùn',
    // ตรงกับคำที่ luck-pillars.ts ใช้ในคอมเมนต์และข้อความอธิบาย
