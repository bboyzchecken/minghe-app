...
const FEATURES = [
  ...
  {
    el: 'earth' as const,
    title: 'ซินแสตรวจทาน (ไฮบริด)',
    desc: 'งานทั่วไปส่งอัตโนมัติทันที · แพ็กพรีเมียมเข้าคิวให้ซินแสตรวจสอบและตีความก่อนปล่อยงาน',
  },
  {
    el: 'fire' as const,
    ...
    <div className="py-14 md:py-20">
      ...
      <section className="container-page mt-16">
        <div className="rounded-xl bg-ink px-8 py-12 text-center text-paper">
          ...
          <p className="mx-auto mt-2 max-w-lg text-paper/80">ทดลองได้ทันทีในเวอร์ชันสาธิต ไม่ต้องสมัคร</p>
